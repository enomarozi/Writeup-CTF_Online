...
```
<p>Perhatikan fungsi write_variable(), disana ada fungsi exec('global '+var_name+';'+var_name+' = '+value) yang bisa digunakan untuk memanggil fungsi win() melalui getRandomNumber(), sederhananya</p>
